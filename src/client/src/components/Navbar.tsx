    ...
    return (
        <div>
                ...
                <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                    <div className="relative flex h-16 items-center justify-between">
                        ...
                        <div className="flex flex-1 mt-2 items-center justify-center sm:items-stretch sm:justify-start">
                            <NavLink to="/">
                                <img alt="MunchMunch Logo" className="h-12 w-auto" src={MunchLogo}></img>
                            </NavLink>
                            <div className="hidden sm:ml-6 sm:block">
                                <div className="flex space-x-10">
                                    ...
                                    <NavLink to="/"
                                       className="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Meine Rezepte
                                    </NavLink>
                                    <NavLink to="/"
                                       className="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Kategorien
                                    </NavLink>
                                    <NavLink to="/"
                                    ...
                                    <NavLink to="/"
                                             className="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Zufällige Empfehlung
                                    </NavLink>
                                </div>
                            </div>
                        </div>
            ...
            {/*<nav className="flex justify-between items-center mb-6">
                <NavLink to="/">
                    <img alt="MunchMunch Logo" className="h-12 inline" src={MunchLogo}></img>
                </NavLink>
